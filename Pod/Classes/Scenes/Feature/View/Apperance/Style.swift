...
public struct Style: StyleProvider {
    ...
    public let lightbackgroundColor: UIColor = Style.lightGrayBackground
    ...
    public let tintColor: UIColor = Style.blue
    public let shadowColor: UIColor = Style.transparentBlack
    public let subBody = UIFont.systemFont(ofSize: 14, weight: .heavy)
    ...
    public let searchText = UIFont.systemFont(ofSize: 15, weight: .medium)
    ...
    static let blue = UIColor(red: 31/255, green: 135/255, blue: 215/255, alpha: 1)
    ...
    static let lightGrayBackground = UIColor(red: 245/255, green: 249/255, blue: 249/255, alpha: 1)
